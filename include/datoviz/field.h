 ...
 * Returns NULL/0 (not an error) if the field has no data yet, or is externally-buffer-backed.
 *
 * @param field the sampled field
...
dvz_sampled_field_data_ptr(const DvzSampledField* field, void** out_ptr, uint64_t* out_size);
